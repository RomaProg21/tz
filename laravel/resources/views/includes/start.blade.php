...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('vendors/css/jquery-jvectormap.min.css')}}">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('vendors/css/jquery.time-to.min.css')}}">
    <!--! END: Vendors CSS-->
    <!--! BEGIN: Custom CSS-->
